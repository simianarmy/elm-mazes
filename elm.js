...
Elm.Maze.make = function (_elm) {
   ...
   var viewWeightedDistances = function (maze) {
      ...
      var sample = $GridCell.maybeGridCellToGridCell(A3($Grid.getCell,wgrid.dgrid.grid,4,4));
      ...
      var lavaPathDistances = A3($DistanceGrid.pathTo,lavaDGrid.dgrid,start,finish);
   ...
   var algByName = function (str) {
      ...
      if (_p9.ctor === "Just") {
            ...
            return A2(_U.crash("Maze",{start: {line: 319,column: 17},end: {line: 319,column: 28}}),"Unknown algorithm",BinaryTree);
         }
   };
