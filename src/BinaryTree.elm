...
step startCellFn neighborsFn grid i =
    let
        cell =
            List.head <| List.reverse <| List.take i (Grid.cellsList grid.cells)
    in
    case cell of
        Just c ->
...
work startCellFn neighborsFn grid cells =
    let
        getRandomNeighbor : Grid -> GridCell -> Maybe GridCell
        ...
        processCell cell grid =
            ...
            case neighbor of
                ...
                Just neighbor ->
                    linkCells grid_ cell neighbor True
    in
